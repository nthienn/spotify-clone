...
<template>
  <div>
      ...
      >
        <div class="flex items-center">
          <img
            class="rounded-full"
            width="27"
            src="https://yt3.googleusercontent.com/XFEZkzS7F8DDOvx4IPMBuR5lpeUQ1iJUuNWHHhvWq7CfU9Df3SulzoAaLnEvGK_vjTKQkGYI8Q=s160-c-k-c0x00ffffff-no-rj"
          />
          <div class="text-white text-[14px] ml-1.5 font-semibold">Anon</div>
          <ChevronDown
            v-if="!openMenu"
            @click="openMenu = true"
            fillColor="#FFFFFF"
    ...
    <div class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
      <RouterLink to="/">
